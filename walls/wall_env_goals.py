...
class PointEnv(gym.Env):
	...
	def __init__(self, walls=None, resize_factor=1,
		...
		self.observation_space = gym.spaces.MultiDiscrete([self._state_size, self._state_size]) # observation is discrete!
	...
	def step(self, action):
		...
		if done: 
			reward = 100 #Reach goal get reward 100, TODO: Is 100 a good value?
	...
	def _get_obs(self):
		return np.array([self._state, self._goal])
